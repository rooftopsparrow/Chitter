...
describe User do
  ...
  it "should reject duplicaate email addresses" do
    User.create!(@attr)
  ...
  describe "password validations" do
    ...
    it "should reject long passwords do" do
      long = "a" * 41
  ...
  describe "password encryption" do
    ...
    describe "authenicate method" do
      ...
      it "should return user with correct email/password pair" do
